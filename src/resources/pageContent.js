const PageContent = {
    ...
    UNEXPECTED_ERROR_MSG: "An unexpected error has been occurred. Please try again later.",
    ...
    STUDENT_FEATURE_CARDS:[
        ...
        {"image":"feature-pic2.png", "title":"Smart Filter","description":"Explore platform’s powerful smart search tool to shortlist your favourite schools"},
        {"image":"feature-pic3.png", "title":"All in one","description":"Apply to multiple schools at once &amp; OneAdmissionForm will be attached automatically"},
        {"image":"feature-pic4.png", "title":"Track Admission","description":"Track, manage applications and accept admission offers to kickstart the journey"},
        {"image":"feature-pic5.png", "title":"Free Counselling","description":"Track, manage applications and accept admission offers to kickstart the journey"},
    ],
    ...
    SCHOOL_DTL_DISCLAIMER: {heading: "Disclaimer", description: "All the data provided is to the best of our knowledge and it can change according to school policies."},
    FACILITY_ICON_MAP: {"Bus": "transport", "Computer Lab":"elearning-icon"},
