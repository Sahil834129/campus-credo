const PageContent = {
    ...
    FACILITY_ICON_MAP: {"Bus": "trasport-icon", "Computer Lab":"computer-lab", "CCTV":"security-icon", "Biometrics":"biometrics-icon", "Digital Learning":"elearning-icon", "Security Personnel":"watchman-icon", "AC Class Rooms":"air-conditioner", "WiFi":"wifi-icon", "Science Lab":"sciencelab-icon", "Disabled Friendly":"disabledfriendly-icon", "Canteen":"canteen-icon", "":"boarding-icon"  },
