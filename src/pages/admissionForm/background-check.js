              ...
              <div className='content-area-inner internal-page-wrapper'>
                ...
                <div className='inner-page-content right'>
                  <div className='inner-page-right-container'>
                    ...
                    <Formik
                      initialValues={{
                        violenceBehaviour: 'true',
                        suspension: 'false',
                        offensiveConduct: 'true'
                      }}
                      onSubmit={values => {
                        saveData(values)
                      }}
                      ...
                      {({ values, errors, touched }) => (
                        <Form className='row g-3'>
                          <div className='col-12 mt-5'>
                            ...
                            >
                              Does the student have any history of violent
                              behaviour?<span className='req'>*</span>
                            </label>
                          ...
                          <div className='col-12 mt-n47'>
                            ...
                            >
                              ...
                              outside of school that involve serious behaviours?
                              <span className='req'>*</span>
                            </label>
                            <div className='d-flex  align-items-center py-2'>
                              <div className='form-check'>
