...
export default function ParentsGuardianForm({
  ...
  const saveData = async (e, formData) => {
    ...
    postData.nationality =
      postData.otherNationality !== ""
        ...
        : postData.nationality;
    postData.relation =
      currentParent !== "other" ? currentParent : postData.otherRelation;
  ...
  useEffect(() => {
    if (values?.state) populateCities(values.state, setCity);
  }, [values.state]);
  ...
  function isValidFormData(formData) {
    ...
    if (!isValidDateOfBirth(formData.dateOfBirth)) return false;
    return true;
  }
  ...
  function isValidDateOfBirth(dateOfBirth) {
    ...
    // }
    if (
      (currentParent === "father" && guardianAge < 21) ||
      (currentParent === "mother" && guardianAge < 18) ||
      (currentParent === "other" && guardianAge < 18)
    ) {
      setValidationErrors({
        ...validationErrors,
        dateOfBirth:
          "Date of birth does not meet the minimum age requirement. Please review and update.",
      });
      return false;
    }
    return true;
              ...
              <div className="fld-row check-option">
                <div className="fld-cell">
                  ...
                  <DatePicker
                    selected={
                      values.dateOfBirth
                        ? parseDateWithDefaultFormat(values.dateOfBirth)
                        : ""
                    }
                  ...
                  />
                  {validationErrors &&
                  validationErrors.hasOwnProperty("dateOfBirth") ? (
                  ...
                  <div className="fld-cell">
                    <div className="title">
                      <label
                        ...
                        className="form-label"
                      >
                        Deceased? <span className="req">*</span>{" "}
                      </label>
                    </div>
                    <div className="option-fld-cell">
                      <div className="input-fld">
                      ...
                      <div className="fld-cell">
                        <SelectField
                          ...
                          onChange={(e) => {
                            ...
                            handleStateChange(setValues, values, {
